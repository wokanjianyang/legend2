namespace Game
{
    ...
    public static class MovementPatterns
    {
        ...
        /// </summary>
        public static readonly Offset[] Full = {new Offset(-1, -1), new Offset(0, -1), new Offset(1, -1), new Offset(-1, 0), new Offset(1, 0), new Offset(-1, 1), new Offset(0, 1), new Offset(1, 1)};

        /// <summary>
        ///     Lateral movement only (west, north, easth, south)
        /// </summary>
        public static readonly Offset[] LateralOnly = {new Offset(0, -1), new Offset(-1, 0), new Offset(1, 0), new Offset(0, 1)};

        /// <summary>
        ///     Diagonal movement only (north-west, north-east, south-east, south-west)
        /// </summary>
        public static readonly Offset[] DiagonalOnly = {new Offset(-1, -1), new Offset(1, -1), new Offset(-1, 1), new Offset(1, 1)};
    }
}