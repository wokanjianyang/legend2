...
namespace Game
{
    ...
    public partial class PillConfig3Category
    {
        ...
        public Dictionary<int, double> ParseLevel(long total)
        {
            ...
            foreach (PillConfig3 config in this.list)
            {
        ...
        public PillConfig3 GetByLevel(long level)
        {
    ...
    public partial class PillConfig3
    {
