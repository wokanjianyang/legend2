...
namespace Game
{
    ...
    public class IdGenerater: IDisposable
    {
        ...
        {
            uint a = (uint)((DateTime.UtcNow.Ticks - this.epoch2020) / 1000);
            return a;
        }
        
        private uint TimeSinceThisYear()
        {
            uint a = (uint)((DateTime.UtcNow.Ticks - this.epochThisYear) / 1000);
            return a;
        }
        ...
        public long GenerateInstanceId()
        {
            ...
            InstanceIdStruct instanceIdStruct = new InstanceIdStruct(this.lastInstanceIdTime, 0, this.instanceIdValue);
        ...
        public long GenerateId()
        {
            ...
            IdStruct idStruct = new IdStruct(this.lastIdTime, 0, value);
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            UnitIdStruct unitIdStruct = new UnitIdStruct(zone, 0, this.lastUnitIdTime, this.unitIdValue);
