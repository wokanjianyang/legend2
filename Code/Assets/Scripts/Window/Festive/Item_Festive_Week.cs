...
public class Item_Festive_Week : MonoBehaviour
{
    ...
    private FestiveWeekConfig Config { get; set; }
    ...
    public void SetData(FestiveWeekConfig config)
    {
        this.Config = config;
        this.Init();
        this.Check();
    ...
    public void OnClickOK()
    {
        ...
        GameProcessor.Inst.EventCenter.Raise(new BattleMsgEvent()
        {
            ...
            Message = BattleMsgHelper.BuildGiftPackMessage("兑换快乐周末奖励:", 0, 0, list)
        });
