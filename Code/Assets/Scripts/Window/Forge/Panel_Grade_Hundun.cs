...
public class Panel_Grade_Hundun : MonoBehaviour
{
    ...
    private const int StartPosition = 41;
    ...
    public void Load()
    {
        ...
        IDictionary<int, Equip> dict = user.EquipPanelHundunList[user.EquipHundunIndex];
