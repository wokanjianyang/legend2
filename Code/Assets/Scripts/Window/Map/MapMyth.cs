...
public class MapMyth : MonoBehaviour, IBattleLife
{
    ...
    public void OnBattleStart()
    {
        ...
        GameProcessor.Inst.EventCenter.AddListener<MythStartEvent>(this.OnStart);
    ...
    public void OnStart(MythStartEvent e)
    {
        ...
        MythConfig config = MythConfigCategory.Instance.Get(e.Id);
        ...
        GameProcessor.Inst.DelayAction(0.1f, () =>
        {
            ...
            GameProcessor.Inst.LoadMap(RuleType.Myth, this.transform, param);
        });
    }
    ...
    {
        if (e.Time == MapTime && e.Type == RuleType.Myth)
        {
            this.Exit();
        }
    }
    ...
    private void Exit()
    {
        ...
        GameProcessor.Inst.EventCenter.Raise(new BattlerEndEvent() { Type = RuleType.Myth });
